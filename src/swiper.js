...
var tem_3_51_sliderset3_init = function tem_3_51_sliderset3_init() {
  ...
  slide.$ScaleWidth("1200");
  slide.$ScaleHeight("427");
...
$(function() {
  ...
  var arrowHeight = $("#slider_smv_tem_3_51 .w-slide-arrowl")
    .eq(-1)
    .outerHeight();
  var arrowTop = (18 - arrowHeight) / 2;
  $("#slider_smv_tem_3_51 .w-slide-arrowl")
    .eq(-1)
    .css("top", arrowTop);
  $("#slider_smv_tem_3_51 .w-slide-arrowr")
    .eq(-1)
    .css("top", arrowTop);
});
